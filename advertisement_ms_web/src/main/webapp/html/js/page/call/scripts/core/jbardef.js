...
//2.4.3	监控事件 13
var eventOnAgentReport             = eventOnAQueryCTIInfoReport+1;
...
function CHtmlBarControl(language)
{
   ...
   //   <web 3000-3999>  
	...
	// <!--CINNGCCA :4000-4299-->";
        ...
        this._addItem(4005,2,"由于网络原因座席和CTI断开，请不要挂机，10S后重新连接!","agent disconnect temporary cause by network,it will be reconnect after ten seconds"); 
