	    ...
	    case cmdMakeCall:
	        {
	            if(this.displayType == NotSurrport_Jquery)
	            {
					...
					shtml = shtml + 	"&nbsp;&nbsp;<input id='senddtmf' onclick='application.oJBarDisplayer.MethodFromUI("+parseInt(id)+")' type='button' value='"+GetLanguageItem(this.language,"二次拨号","senddtmf")+"' >";
	    ...
	    case cmdConsult:
	        {
	            if(this.displayType == NotSurrport_Jquery)
	            {
					...
					shtml = shtml + 	"<p align='center'>&nbsp;&nbsp;&nbsp;&nbsp;<input id='senddtmf' onclick='application.oJBarDisplayer.MethodFromUI("+parseInt(id)+")' type='button' value='"+GetLanguageItem(this.language,"二次拨号","senddtmf")+"' >";
		        ...
		        else
		        {
					...
					var aa="cmdReleaseThirdOne";
		            this.oInputDisplay  = new JBarDialog(260,60,340,300,null);
			        var shtml = "<p>&nbsp;&nbsp;"+GetLanguageItem(this.language,"咨询类型","consultTypeType")+":";
	...
	this.ChangeBtnStatus = function(btns){
	    ...
	    {	
           ...
           else
           {
                ...
                $("#btn_"+this._showBtns[i]).linkbutton('disabled');	
				alert("btn_"+this._showBtns[i]);
			/*	 //转移
			   if("btn_"+this._showBtns[i]=="btn_7"){
                   document.getElementById("transfer").disabled="disabled";
			   }
    ...
    this.showAgentStatusTimer = function ()
    {
        ...
        {    
		   ...
		   //转移
			   ...
			   //挂断第三方
			   if("btn_"+this._showBtns[i]=="btn_31"){
                   document.getElementById("releaseThirdOne").disabled=true;
			   }
			   //二次拨号
			   if("btn_"+this._showBtns[i]=="btn_12"){
                   document.getElementById("senddtmf").disabled=true;
			   }
           oBtn.disabled = true;                   
        }
        else
