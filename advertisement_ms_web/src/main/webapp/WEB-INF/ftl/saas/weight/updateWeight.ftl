				...
				<tr>
                    ...
                    <td>
                      ...
                      <select name="gameId" class="selectpicker form-control">
                        ...
                        <option value="${list.gameId?c}" <#if itemEdit.gameId == itemEdit.gameId>selected</#if>>${list.shortName}</option>
                        </#list>
                      </select>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <select name="platformId" class="selectpicker form-control">
                        ...
                        <option value="${list.platformId?c}" <#if itemEdit.platformId == itemEdit.platformId>selected</#if>>${list.platformName}</option>
                        </#list>
                      </select>
                      </div>
                    </td>
                  ...
                  <tr>
                    <td>标记：</td>
                    <td>
                      <input type="text" name="remark" style="width:60%;" value="${itemEdit.remark}"></td>
                  </tr>
