...
<div id="content">
  ...
  <div class="container-fluid">
    <hr>
    <div class="row-fluid">
      <form action="${rc.contextPath}/admin/article/${functionName}/insert.do" method="post" name="form" enctype="multipart/form-data" target="formCommitIframe">
              ...
              <table class="table table-bordered table-striped" id="">
                <tbody>
                  ...
                  <tr>
                    <td>内容：</td>
                    <td>
                    <textarea type="text" name="content" style="width:60%; height:200px;"></textarea>
                    </td>
                  </tr>
