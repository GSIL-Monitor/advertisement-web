            ...
            <div class="widget-content nopadding">
              <table class="table table-bordered table-striped" id="">
                <tbody>
                  ...
                  <tr>
                    <td style="width:20%;">兑换码个数(填写数字)：</td>
                   <td>
						<input id="inviteNumber" type="text" name="number" style="width:60%;">
				   </td>
                  </tr>
                 
                  <tr>
                    <td colspan="4" style="text-align:center">
                      <input type="submit" name="" value="提交" class=" btn btn-green" style="width: 100px;border: 0;" onclick="getInviteFile('${rc.contextPath}/admin/${functionName}/redeem.do');""></td>
                  </tr>
                </tbody>
              </table>
            </div>
