<#include "core.ftl" />
<@htmlHead title="${channel}${functionTitle}"/>
<@headerPart />
<@topHeaderMenu />
<@sideBar />
<div id="content">
									...
									<tbody>
										<#list configCategoryList as categoryElement>
										 <tr style="color:#FF6347; font-size:18px;">
											<td>类型：${categoryElement.configCategory}</td>
											<td></td>
										 </tr>
												...
												<tr>
													...
													<td>
														<div style="width:40%;">
															...
															<#else>
																<input type="text" name="${item.key}" style="width:60%;" value="${item.defaultAction}"/>
															</#if>
														</div>
													</td>
												</tr>
