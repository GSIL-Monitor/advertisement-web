...
<div id="content">
  ...
  <div class="container-fluid">
    <hr>
    <div class="row-fluid">
      <form action="${rc.contextPath}/admin/${functionName}/insert.do" method="post" name="form" enctype="multipart/form-data" target="formCommitIframe" id="ueditorForm">
              ...
              <table class="table table-bordered table-striped" id="">
                <tbody>
                   ...
                   <tr>
                    ...
                    <td colspan="3">
                      <iframe id="iFrameUeditor" src="${rc.contextPath}/admin/article/editor.do" frameborder="0" ></iframe>
                    </td>
                  </tr>
