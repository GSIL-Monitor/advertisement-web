            ...
            <div class="widget-content nopadding">
              <table class="table table-bordered table-striped" id="">
                ...
                <tr>
               	    <td>活动类型：</td>
                    <td>
                      <input type="text" name="actionType" style="width:60%;"></td>
                  </tr>
                  
                  <tr>
                    <td>详细链接：</td>
                    <td>
                      <input type="text" name="detailUrl" style="width:60%;"></td>
                  </tr>
                  
                   <tr>
                    <td>开始时间：</td>
                    <td>
                      <input type="text" id="effects" name="bannerStartTime" style="width:60%;">
                   </td>
                  </tr>
                  ...
                  <tr>
                    <td>结束时间：</td>
                    <td>
                      <input type="text" id="effect" name="bannerEndTime" style="width:60%;">
                   </td>
                  </tr>
