              ...
              <table class="table table-bordered table-striped" id="">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <input type="text" name="name" style="width:60%;" value="${itemEdit.name}">
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>key：</td>
                    <td>
                      <input type="text" name="key" style="width:60%;" value="${itemEdit.key}">
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>入口地址：</td>
                    <td>
                      <input type="text" name="entranceUrl" style="width:60%;" value="${itemEdit.entranceUrl}">
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>bonus：</td>
                    <td>
                      <input type="text" name="bonus" style="width:60%;" value="${itemEdit.bonus?c}">
                    </td>
                  </tr>
