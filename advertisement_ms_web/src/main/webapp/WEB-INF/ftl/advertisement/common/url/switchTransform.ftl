            ...
            <div class="widget-content nopadding">
              <table class="table table-bordered table-striped" id="">
                <tbody>
                  ...
                  <tr>
                    <td style="width:20%;">转换链接：</td>
                    <td>
                      <textarea id="transformUrl" name="needTransformUrl" style="width:60%;height:50px"></textarea></td>
                  </tr>
                 
                  <tr>
                    <td colspan="4" style="text-align:center">
                      <input type="submit" name="" value="提交" class=" btn btn-green" style="width: 100px;border: 0;" onclick="uploadShortUrl('${rc.contextPath}/admin/${functionName}/transform.do');""></td>
                  </tr>
                </tbody>
              </table>
            </div>
