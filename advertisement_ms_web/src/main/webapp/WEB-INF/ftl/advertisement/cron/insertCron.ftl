              ...
              <table class="table table-bordered table-striped" id="">
                <tbody>
                 ...
                 <tr>
                    <td>名称：</td>
                    <td>
                      <input type="text" name="beanName" style="width:60%;"></td>
                  </tr>
                  
                <tr>
               	    <td>方法：</td>
                    <td>
                      <input type="text" name="beanMethod" style="width:60%;"></td>
                  </tr>
                  
                  <tr>
                    <td>运行模式：</td>
                    <td>
                      <input type="text" name="executeMode" style="width:60%;"></td>
                  </tr>
                   ...
                   <tr>
                    <td>cron：</td>
                    <td>
                      <input type="text" name="cron" style="width:60%;"></td>
                  </tr>
