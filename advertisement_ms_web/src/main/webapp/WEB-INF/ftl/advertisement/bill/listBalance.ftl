...
<script>
	...
	$(document).ready(function(){
		dataTableConfig.ajax = "${rc.contextPath}/admin/${functionName}/queryBanlance.do?advertiserId=${advertiserId}";
		dataTableConfig.columns = [{
		        ...
		        "render": function ( data, type, full, meta ) {
		            return '<a href="${rc.contextPath}/admin/${functionName}/rechargeWindow.do?advertiserId='+data+'"  class="btn btn-cyan" target="_blank">充值</a>';
		        }
		    },  {
		    	"data": "description"
		    }];
