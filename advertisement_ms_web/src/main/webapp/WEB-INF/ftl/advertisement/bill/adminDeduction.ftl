...
<div id="content">
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<form action="${rc.contextPath}/admin/${functionName}/deductionByAdmin.do" method="post" name="form" enctype="multipart/form-data" target="formCommitIframe">
				<div class="span12">
							...
							<table class="table table-bordered table-striped" id="">
								<tbody>
									<tr>
										<td>计划ID：</td>
										<td>
											<input type="text" name="planId" style="width:60%;"></td>
										</td>
									</tr>
									<tr>
										<td>金额：</td>
