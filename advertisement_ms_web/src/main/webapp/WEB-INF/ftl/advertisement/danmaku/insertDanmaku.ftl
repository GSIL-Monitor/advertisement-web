							...
							<table class="table table-bordered table-striped" id="">
								<tbody>
										...
										<td>
											<div style="width:62%;">
												<select name="staffRoleId" id="staffRoleId" class="selectpicker form-control">
													...
													<option value="${staffRole.staffRoleId?c}">${staffRole.name}</option>
													</#list>
												</select>
											</div>
										</td>
										...
										<td>
											<div style="width:62%;">
												<select name="showStaffId" id="showStaffId" class="selectpicker form-control" data-live-search="true">
													...
													<option value="${staff.staffId?c}">${staff.name}</option>
													</#list>
												</select>
											</div>
										</td>
									...
									<tr>
										<td>内容：</td>
										<td>
											<textarea name="content" style="width:60%;height: 2.5rem;"></textarea></td>
									</tr>
