...
<script>
	$(document).ready(function(){
		...
		dataTableConfig.ajax = "${rc.contextPath}/admin/${functionName}/queryGameRecord.do";
		...
		$('#date').change(function(){
			var date=$('#date').val();
			var newUrl="${rc.contextPath}/admin/${functionName}/queryGameRecord.do?statisticsDate="+encodeURI(encodeURI(date));
			dataTable.ajax.url(newUrl);
			dataTable.ajax.reload();
		});
	});
