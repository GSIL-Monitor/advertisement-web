...
public class StackTraceUtil {
	...
	public static String getCurrentStackTracePrintValue(){
		StackTraceElement[] stackElements = new Throwable().getStackTrace();
		...
		for(int i = 0; i < stackElements.length; i++){
			sb.append(stackElements[i].getClassName()).append("(").append(stackElements[i].getLineNumber()).append(")\n");	       
		}
		return sb.toString();
	}
	
	public static String getCurrentStackTracePrintValue(Thread thread){
