...
public class MD5Util {
	...
	public static String encryptPassword(String password, String userId) {
		...
		return MD5Util.get(MD5Util.get(password) + userId);
	}
	 ...
	 * @return MD5校验结果
	 */
	public static boolean validate(String password, String inputString, String codeType) {
	...
	public static String changeToEncryptPassword(String password, int userId) {
		return MD5Util.get(MD5Util.get(password) + userId);
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(MD5Util.get(
				"http://movie.mall.163.com/order/confirm.html?order_id=2012102514GORDER00149540E2tPkfwK9bg8R8pw",
				"UTF-8"));
		System.out.println(MD5Util.validate("a9d134563a43f8178ef55036b4da42fb",
				"9:02|9:010000059595wy_seat_c4c3abda71010eE2tPkfwK9bg8R8pw", "UTF-8"));
