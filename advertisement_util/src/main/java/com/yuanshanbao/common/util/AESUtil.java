...
import com.yuanshanbao.common.exception.DecryptException;
import com.yuanshanbao.common.exception.EncryptException;
import com.yuanshanbao.common.exception.ParameterException;
...
public class AESUtil {
	// public static byte[] IV_BYTES = { 0x12, 0x34, 0x56, 0x78, 0x90, 0xAB,
	// 0xCD,
	 ...
	 */
	public static String encrypt(String sSrc, String sKey) throws ParameterException, EncryptException,
			NoSuchAlgorithmException, GeneralSecurityException {
		if (sSrc == null || sSrc.trim().length() == 0 || sKey == null || sKey.trim().length() == 0) {
	 ...
	 */
	public static String decrypt(String encryptedString, String sKey) throws ParameterException, DecryptException {
		if (encryptedString == null || encryptedString.trim().length() == 0 || sKey == null
				|| sKey.trim().length() != 16) {
			throw new ParameterException();
		}
	 ...
	 * @return
	 */
	public static String encryptForCMode(String content, String password, String charsetName) {
		try {
			...
			// 为了和.NET加密一致修改为
			byte[] enCodeFormat = password.getBytes(charsetName);// MD5Util.get(password,
																	// charsetName)
			// ///////////////////////以上已经修改/////////////////////////
	 ...
	 * @return
	 */
	public static String decryptForCMode(String encryptedString, String password, String charsetName) {
		try {
			if (charsetName == null || "".equals(charsetName.trim()))
				charsetName = "UTF-8";
			// KeyGenerator kgen =
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("解密串：" + AESUtil.decryptForCMode(miwen, key, "UTF-8"));
