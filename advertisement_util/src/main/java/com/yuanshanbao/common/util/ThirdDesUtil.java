...
public class ThirdDesUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		byte[] keyBytesTW = { 0x7A, (byte) 0x92, (byte) 0xC9, 0x3B, 0x27, (byte) 0xE9, (byte) 0xCD, 0x67, 0x16, 0x3C,
				0x34, 0x20, 0x02, 0x76, 0x36, 0x52, 0x20, 0x2C, 0x74, 0x54, (byte) 0xF2, 0x3D, (byte) 0xA2, (byte) 0xEA };
		...
		String encResult = new sun.misc.BASE64Encoder().encode(
				ThirdDesUtil.encryptWithThiDES(keyBytesTW, ("a中文1234abc").getBytes("utf-8"))).replaceAll("\r\n", "");
		System.out.println(encResult);// sKTaNMF8Y8qrv4jSahqhPQ==
		String deResult = new String(ThirdDesUtil.decryptWithThiDES(keyBytesTW,
				new sun.misc.BASE64Decoder().decodeBuffer(encResult)), "UTF-8");
