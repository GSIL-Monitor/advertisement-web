...
.rotary-table {
  ...
  .marquee {
    ...
    img {
      width: 100%;
      display: block;
    } // background: url('@{imgUrl}/paomadeng0.png')
    //   no-repeat;
    // background-size: 100%;
    // animation: marquee 2s infinite steps(2);
  }
  .bg {
    position: absolute;
    left: 0;
  ...
  //   0% {
  //     background-image: url('@{imgUrl}/paomadeng0.png');
  //   }
  //   100% {
  //     background-image: url('@{imgUrl}/paomadeng1.png');
  //   }
  // }
}
</style>
