...
<@htmlHead title="免费领取20万元中英交通意外保障" description="">
	...
	<@cssFile file=["web/activity/zhongying/xjhb-web.css"] />
</@htmlHead>
<#-- 结果弹窗 -->
		...
		<div class="form-wrap clearfix">
			<div class="survey-area left">
				<div class="description-title">
					<img src="${cdnUrl}/img/web/activity/zhongying/xjhb/survey-title.png">
				</div>
				<@surveyFormZhongYing/>
			</div>
			<div class="form-area right">
				<div class="description-title">
					<span>
						<img src="${cdnUrl}/img/web/activity/zhongying/xjhb/form-title.png">
					</span>
				</div>
				<@commonZengXianForm/>
