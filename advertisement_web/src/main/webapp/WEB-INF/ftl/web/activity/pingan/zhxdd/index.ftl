...
<@htmlHead title="免费领万元账户安全保障送100元滴滴红包" description="">
...
<@resultPopWindow title="" buttonText="立即领取100元滴滴红包" buttonFunction=""/>
<#-- 问卷弹窗 -->
<@surveyPopWindow title="完成下面问题，立即领取赠险。" buttonText="提交" buttonFunction=""/>
<@commonHeader/>
<div class="orange-banner">
	<@commonBanner path="pingan/zhxdd" />
</div>
<div class="container">
	<div class="wrapper">
		<div class="counter">
		...
		<div class="form-wrap">
			<div class="ddhb-form">
				...
				<img class="coupon" src="${cdnUrl}/img/web/activity/pingan/zhxdd/zhxlb_coupon.png" alt="">
				<p class="coupon-title">100元现金红包+万元账户保障</p>
			</div>
		</div>
		<div class="line"></div>
