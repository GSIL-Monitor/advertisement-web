			...
			<div class="form-area">
				...
				<div class="protocal">
					<span>
						...
						我已阅读<#-- <a href="javascript:;" onclick="showActivityRule();">《活动规则》</a>及 --><a href="javascript:;" onclick="showProtocol();">《安全条款》</a>并同意平安保险致电确认免费保障生效事宜
					</span>
...
<div id="insuranceDetailTip" class="tip-area insurance-detail-tip hide">
	<div class="tip-window center">
		<div class="favorite-tip">
			<img id="insuranceDetailImg" src="${cdnUrl}/img/wap/activity/pingan/xjhb/insurance-detail.png">
		</div>
	</div>
</div>
