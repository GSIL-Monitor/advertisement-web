...
<@htmlHead title="免费领取1万元账户安全保障" description="">
	...
	<@cssFile file=["wap/activity/pingan/xzhx.css", "wap/base.css", "plugins/mobiscroll.custom-2.17.0.min.css"] />
</@htmlHead>
<@calculatePage/>
<div class="container">
	...
	<div class="wrapper">
		...
		<div class="protocal">
			<span>
				<img src="${cdnUrl}/img/wap/activity/pingan/xzhx/check.png"/>
		...
		<div class="insurance-description">
			<img src="${cdnUrl}/img/wap/activity/pingan/xzhx/description.png"/>
		</div>
		<@randomSmsToken/>
		<#-- 尾部 -->
