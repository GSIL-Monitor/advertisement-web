...
<@htmlHead title="免费领出行保障抽奖赢取iPhone 7 Plus" description="">
...
<div class="container">
	<@commonHeader/>
	<@commonBanner path="pingan/iphone"/>
	...
	<div class="wrapper">
		...
		<div class="insurance-description">
			<div class="insurance-table">
				<img src="${cdnUrl}/img/wap/activity/pingan/iphone/table-content.png">
			</div>
...
<@resultPopWindow title="" buttonText="参与保费测算抽奖赢取iPhone 7 Plus" buttonFunction=""/>
