...
<@htmlHead title="领50万出行保障，送25元现金红包" description="">
			...
			<div class="form-area">
				...
				<div class="protocal">
					<span>
						...
						我已阅读<#-- <a href="javascript:;" onclick="showActivityRule();">《活动规则》</a>及 --><a href="javascript:;" onclick="showProtocol();">《安全条款》</a>并同意华夏保险致电确认免费保障生效事宜
					</span>
					<@commonProtocolContent merchantName="华夏" merchantDomain="www.hxlife.com"/>
					<#-- <div id="activityRulePopWindow" class="hide">
						<@activityRule defaultInsurance="华夏保险" otherInsurance="平安人寿、泰康人寿、中美大都会、百年人寿、中英人寿"/>
					</div> -->
				</div>
			</div>
...
<div id="insuranceDetailTip" class="tip-area insurance-detail-tip hide">
	<div class="tip-window center">
		<div class="favorite-tip">
			<img id="insuranceDetailImg" src="${cdnUrl}/img/wap/activity/huaxia/xjhb/insurance-detail.png">
		</div>
	</div>
</div>
<#-- 邮箱弹窗 -->
...
<#macro resultTitleArea>
	<p>已成功领取<span class="money">华夏交通意外险</span>，华夏客服后续将致电以确认免费保险生效事宜。</p>
</#macro>
