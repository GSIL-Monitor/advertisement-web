...
<@htmlHead title="${resultTitle}" description="">
	...
	<@cssFile file=["common/activity/shanyin/pinganth.css"] />
</@htmlHead>
...
<div class="container result-container">
	...
	<div class="policy-description">
		...
		<#if result?? && result=="true">
		<div class="link-button" id="linkButton">
			<span class="link-button-content">查看超级社保卡</span>
		</div>
		</#if>
	</div>
	<#if insurant?? && insurant.policyNumber??>
...
<div class="policy-footer">
	<@footer activityPath="/pingan/syth"/>
</div>
<#if !(insurant?? && insurant.policyNumber??)>
