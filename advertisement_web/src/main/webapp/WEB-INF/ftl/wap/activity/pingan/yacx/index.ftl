...
<@htmlHead title="免费领取100万平安出行险" description="">
	<@jsFile file=["common/zengxian.js", "plugins/mobiscroll.custom-2.17.0.min.js"] />
	<@cssFile file=["wap/base.css", "wap/activity/pingan/yacx.css", "plugins/mobiscroll.custom-2.17.0.min.css"] />
</@htmlHead>
<@calculatePage/>
<#if isRuJia?? && isRuJia=="true">
<div class="container" style="background-color: #fff;">
	<div class="header-embed">
		<div class="header">
			<div class="header-wrap">
				<img src="${cdnUrl}/img/wap/activity/pingan/yacx/rujia.png">
			</div>
		</div>
	</div>
	<div class="banner-wrap">
		<div class="banner">
			<img src="${cdnUrl}/img/wap/activity/pingan/yacx/banner-rujia.png?${cdnFileVersion}">
		</div>
	</div>
<#else>
<div class="container">
	...
	<div class="wrapper">
		...
		<div class="form-background">
			<div class="form-area">
				...
				<div class="form-title">
					参与调查，免费领<span class="money">100万</span>出行险
				</div>
				<@surveyForm/>
		...
		<div class="insurance-description">
			<img src="${cdnUrl}/img/wap/activity/pingan/yacx/description<#if isRuJia?? && isRuJia=="true">-rujia</#if>.png"/>
		</div>
		<@randomSmsToken/>
		<#-- 尾部 -->
