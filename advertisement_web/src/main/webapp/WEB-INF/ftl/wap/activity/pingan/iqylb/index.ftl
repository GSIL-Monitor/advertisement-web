...
<@htmlHead title="领100万平安出行保障，送60元爱奇艺礼包" description="">
	<@jsFile file=["common/zengxian.js", "plugins/mobiscroll.custom-2.17.0.min.js"] />
	<@cssFile file=["wap/base.css", "wap/activity/pingan/iqylb.css", "plugins/mobiscroll.custom-2.17.0.min.css"] />
</@htmlHead>
<@calculatePage/>
<div class="container">
	<@commonBanner path="pingan/iqylb"/>
		...
		<div class="form-background">
			...
			<div class="form-area">
				...
				<div class="form-input-title">
					<img src="${cdnUrl}/img/wap/activity/pingan/iqylb/pen.png">
					<p>完善信息，领取出行大礼包</p>
				</div>
				<#-- 字段 -->
				...
				<div class="protocal">
					<span>
						<img src="${cdnUrl}/img/wap/activity/pingan/iqylb/check.png"/>
...
<div id="insuranceDetailTip" class="tip-area insurance-detail-tip hide">
	<div class="tip-window center">
		<div class="favorite-tip">
			<img id="insuranceDetailImg" src="${cdnUrl}/img/wap/activity/pingan/iqylb/insurance-detail.png">
		</div>
	</div>
</div>
