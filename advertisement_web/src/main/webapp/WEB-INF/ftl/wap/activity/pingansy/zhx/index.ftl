...
<@htmlHead title="免费领取1万元账户安全保障" description="">
	...
	<@cssFile file=["common/activity/shanyin/pinganzhx.css", "plugins/mobiscroll.custom-2.17.0.min.css"] />
</@htmlHead>
<div class="container">
	<#-- 头部信息（包括公司logo，菜单等） -->
	<#-- <div class="header">
	...
	<div class="banner">
		<img src="${cdnUrl}/img/wap/activity/pingansy/zhx/banner.png">
	</div>
	...
	<div class="wrapper">
		...
		<div class="form-area">
			...
			<div class="form-item">
				...
				<div class="right input-area">
					...
					<input type="hidden" id="smsTipContent" value="平安账户安全保障"/>
				</div>
			</div>
			...
			<div class="submit-button-area">
				<div class="submit-button" id="submitButtonWithEmailTip">
					立即领取
				</div>
			</div>
		...
		<div class="insurance-description">
				...
				<div class="product-description">
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td>
								个人银行/网络账户损失，保障<span class="money">10000元</span>
							</td>
						</tr>
					</table>
				</div>
			...
			<div>
				<img src="${cdnUrl}/img/wap/activity/pingansy/zhx/description.png" style="width:100%" />
			</div>
			<div class="activity-rule">
				<h3>投保须知</h3>
				<p>1、有效参与用户身体健康，须要在25-50周岁</p>
				<p>2、每位用户限领1份账户安全保障，多次领取无效</p>
