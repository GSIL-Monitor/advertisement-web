...
<@htmlHead title="办信用卡送话费" description="">
	...
	<@cssFile file=["wap/base.css", "wap/loan/pfxykes.css", "plugins/mobiscroll.custom-2.17.0.min.css"] />
</@htmlHead>
<@calculatePage/>
<div class="container">
	<div class="banner">
		...
		<#else>
		<img src="${cdnUrl}/img/wap/loan/pfxykes/banner.jpg?${cdnFileVersion}">
		</#if>
	</div>
	...
	<div class="wrapper">
		...
		<div class="form-area">
			...
			<p class="tip">* 核卡成功后15个工作日内20元话费将充值到该手机</p>
			<div class="activity-rule">
				<div class="title"></div>
				<div class="rule">
					<p>1、活动有效期：2018年1月1日-2018年2月28日；</p>
					<p>2、每个用户每个手机号仅限参与1次，多次参与无效；</p>
					<p>3、通过此活动入口参与办理信用卡，并成功通过信用卡中心审核批复的客户，才能获得价值20元的话费；</p>
				    <p>4、核卡成功后15个工作日内我们会以短信的方式通知您的20元手机话费到账情况；</p>
				</div>
			</div>
			<div class="warm-tips">
				<span>【特别提示】“办卡送话费”为兴贷贷款平台回馈新老用户的促销活动，与各银行信用卡中心无关，最终解释权归兴贷款贷款平台所有！</span>
			</div>
		</div>
		<@randomSmsToken/>
