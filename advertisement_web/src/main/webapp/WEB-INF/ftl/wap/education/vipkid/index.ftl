...
<div class="container">
	<div class="logo">
		<img src="${ossUrl}/img/wap/education/vipkid/logo@3x.png" alt="">
	</div>
<#-- 	<div class="top-right">
		<img src="${ossUrl}/img/wap/education/vipkid/right-top@3x.png" alt="">
	</div> -->
	<div class="banner">
		<#if customBannerConfig?? && (customBannerConfig?length > 0)>
		<img src="${customBannerConfig}">
		<#else>
		<img src="${ossUrl}/img/wap/education/vipkid/banner.png?${cdnFileVersion}">
		</#if>
	</div>
	<div class="wrapper">
		<#-- 填写赠险表单信息区域 -->
		<div class="form-background">
			<div class="form-area">
				<div class="form-title">
					<img src="${ossUrl}/img/wap/education/vipkid/tittle@3x.png" alt="">
				</div>
				<#-- 字段 -->
				...
				<div class="form-limit">每天限额50名</div>
			</div>
		</div>
	</div>
	<div class="desc">
