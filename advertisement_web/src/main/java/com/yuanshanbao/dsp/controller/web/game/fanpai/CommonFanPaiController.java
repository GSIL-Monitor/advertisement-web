package com.yuanshanbao.dsp.controller.web.game.fanpai;
...
@RequestMapping({ "/activity/fanpai/common", "/m/activity/fanpai/common" })
@Controller
public class CommonFanPaiController extends BaseFanPaiController {
