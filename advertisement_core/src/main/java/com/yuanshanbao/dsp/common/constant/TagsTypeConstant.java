...
public class TagsTypeConstant {
	...
	public static final String ORDER_COMMENT = "order_comment_tags";
	public static final String CONTACT_TAGS = "contact_tags";
	public static final String INSURANCE_CATEGORY_TAGS = "insurance_category_tags";
	public static final String INSURANCE_RANGE_TAGS = "insurance_range_tags";
	public static final String ORDER_NEGATIVE_COMMENT = "order_negative_comment_tags";
