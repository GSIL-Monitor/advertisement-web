package com.yuanshanbao.ad.activity.model.vo;
...
import com.yuanshanbao.ad.tags.model.vo.TagsFieldVo;
...
public class ActivityStepVo {
		...
		for (InformationFieldVo vo : informationFieldVoList) {
			...
			for (InformationFieldVo informationFieldVo : vo.getReferenceList()) {
				...
				for (TagsFieldVo fieldVo : fieldVos) {
					if (ValidateUtil.isNumber(informationFieldVo
							.getRelativeValue())
							&& fieldVo.getTagsId().equals(
									Long.parseLong(informationFieldVo
											.getRelativeValue()))) {
	...
	public void setInformationFieldVoList(
			List<InformationFieldVo> informationFieldVoList) {
