...
public class JedisAop
{
	...
	@After("@annotation(com.yuanshanbao.ad.redis.base.JedisWay) || @within(com.yuanshanbao.ad.redis.base.JedisWay)")
	...
	@AfterThrowing("@annotation(com.yuanshanbao.ad.redis.base.JedisWay) || @within(com.yuanshanbao.ad.redis.base.JedisWay)")
